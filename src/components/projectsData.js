...
export const projectsData = [
    {
        ...
        description1: "Zero filtri, zero paranoie e tutto il cuore della Gen Z che ti arriva dritta in faccia, e allo stomaco. Niente foto in posa e testi noiosi: copy, visual e format si rincorrono per creare un racconto fresco in cui è impossibile non ritrovarsi.",
        description2: "Invece del solito brand che fa il monologo dal pulpito, abbiamo tirato su un feed che sembra un pezzo di vita vera tra ironia a palate e zero barriere perché abbiamo parlato direttamente con il pubblico.",
        description3: "Se vuoi fare breccia nel cuore di chi scrolla devi creare un posto in cui la gente ha voglia di tornare e sentirsi parte della compagnia. Ancora prima di aver appoggiato il culo sulla sedia.",
    ...
    },
    {
        ...
        description4: "Zero foto tristi da magazzino, solo dettagli chirurgici e silenzi che parlano. Risultato? Un feed essenziale, pulito, quasi sospeso nello spazio. Un profilo che trasuda un'estetica è rigorosa quanto la tecnica. Roba così bella che, alla fine, ti dispiace quasi scartare il pacco.",
        interazioni: "+157.000 PERSONE RAGGIUNTE",
        tags: [
            "art direction",
            "creative copywriting",
